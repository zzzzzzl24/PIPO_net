...
parser.add_argument('--volume_path', type=str,
                    default='./MyoPS++/process/cine_sa/test_vol_h5', help='root dir for validation volume data')  # for acdc volume_path=root_dir
parser.add_argument('--dataset', type=str,
                    default='QS_Seg_MyoPS', help='experiment_name')
parser.add_argument('--num_classes', type=int,
                    default=4, help='output channel of network')
parser.add_argument('--list_dir', type=str,
                    default='./P2/PIPO_net/list', help='list dir')
...
parser.add_argument('--test_save_dir', type=str, default='./P2/PIPO_net/predictions', help='saving prediction as nii!')
...
parser.add_argument("--exp_name", type=str, default="this is your exp name", help="experiment name")
...
if __name__ == "__main__":
    ...
    snapshot_path = "./P2/PIPO_net/results/{}".format(args.exp)
    ...
    log_folder = './P2/PIPO_net/test_log/' + args.exp
    ...
    if args.is_savenii:
        args.test_save_dir = './P2/PIPO_net/predictions/{}'.format(exp_name)
