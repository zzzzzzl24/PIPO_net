...
def preprocess_train_image(image_files: str, label_files: str) -> None:
    os.makedirs(f"/data/fangdg/transunet/data_0211_ourdata/process/train_npz", exist_ok=True)
    ...
    for image_file, label_file in pbar:
        ...
        for dep in range(D):
            save_path = f"/data/fangdg/transunet/data_0211_ourdata/process/train_npz/{name}_slice{dep:03d}.npz"
...
def preprocess_valid_image(image_files: str, label_files: str) -> None:
    os.makedirs(f"/data/fangdg/transunet/data_0211_ourdata/process/test_vol_h5", exist_ok=True)
    ...
    for image_file, label_file in pbar:
        ...
        save_path = f"/data/fangdg/transunet/data_0211_ourdata/process/test_vol_h5/{name}.npy.h5"
...
if __name__ == "__main__":
    data_root = "/data/fangdg/transunet/data_0211_ourdata/raw/t2w"
    filenames = []
    # String sort
