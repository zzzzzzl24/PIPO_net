...
parser = argparse.ArgumentParser(description="Prompt-Guided Modality Completion for Incomplete Multi-Modal Myocardial Pathology Segmentation")
parser.add_argument('--root_path', type=str,
                    default='./MyoPS++/process/cine_sa/train_npz', help='root dir for data')
parser.add_argument('--dataset', type=str,
                    default='QS_Seg_MyoPS', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='./P2/PIPO/list', help='list dir')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'QS_Seg_MyoPS': {
            'root_path': './MyoPS++/process/cine_sa/train_npz',
            'root_path1':'./MyoPS++/process/psir/train_npz',
            'root_path2':'./MyoPS++/process/t2w/train_npz',
